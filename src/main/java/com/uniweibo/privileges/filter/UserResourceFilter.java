 ...
 * @since 2014-10-16
 * @update 2014-10-16
 * @desc 检查useid对应的resources 是否有权限的 伪filter
 * @version 1.0
 * 
 */
public class UserResourceFilter implements IPrivilegeFilter {
	 ...
	 * @since 2014-10-16
	 * @update 2014-10-16
	 * @desc  检查useid对应的resources 是否有权限 doPrivilegeFilter入口 
	 * @version 1.0
	...
	public int doPrivilegeFilter(ServletRequest request, ServletResponse response, FilterChain chain, Object... privilegeObjects) throws IOException, ServletException {
		...
		//根据userid 查出对应的资源列表
		Set<String> resourceSet = userRedis.selectResourceByUid(uid);
